        ...
        <div class="container-fluid">       
                <div class="row">
                    <div class="col-md-4">
                            ...
                            <a href="bitacora_editar.html" class="btn btn-block btn-outline-primary btn-lg">Editar regristro</a>
                            <a href="bitacora_nuevo.html" class="btn btn-block btn-lg btn-outline-primary">Nuevo regristro</a>
                            <a href="" class="btn btn-block btn-lg btn-outline-primary">Eliminar regristros</a>
                    </div>
                    <div class="col-md-8">
                        <h3>
                            Bitacora
                        ...
                        <div id="card-230654">
                            <div class="card">
                                <div class="card-header">
                                    <a class="card-link collapsed" data-toggle="collapse" data-parent="#card-230654" href="#card-element-866869">Regrsitro ejemplo</a>
                                </div>
                                <div id="card-element-866869" class="collapse">
                                    <div class="card-body">
                                        <h5>Notas</h5>
